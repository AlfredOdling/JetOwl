...
<html lang="en">
<head>
    <title>Code coverage report for auth/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">auth</a> index.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Client from '../networking';
...
export default class Auth {
  constructor(options = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
...
&nbsp;
   ...
   * @memberof Auth
   */
  authorizeUrl(parameters = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    const query = apply({
      parameters: {
...
&nbsp;
   ...
   * @memberof Auth
   */
  logoutUrl(parameters = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    const query = apply({
      parameters: {
...
&nbsp;
   ...
   * @memberof Auth
   */
  exchange(parameters = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    const payload = apply({
      parameters: {
        code: { required: true },
...
&nbsp;
   ...
   * @memberof Auth
   */
  passwordRealm(parameters = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    const payload = apply({
      parameters: {
...
&nbsp;
   ...
   * @memberof Auth
   */
  refreshToken(parameters = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    const payload = apply({
      parameters: {
...
&nbsp;
   ...
   * @memberof Auth
   */
  revoke(parameters = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    const payload = apply({
      parameters: {
...
&nbsp;
   ...
   * @memberof Auth
   */
  userInfo(parameters = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    const payload = apply({
      parameters: {
        token: { required: true }
      }
...
&nbsp;
   ...
   * @memberof Auth
   */
  resetPassword(parameters = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    const payload = apply({
      parameters: {
        email: { required: true },
...
&nbsp;
   ...
   * @memberof Auth
   */
  createUser(parameters = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    const payload = apply({
      parameters: {
        email: { required: true },
        password: { required: true },
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Aug 13 2018 16:40:18 GMT-0300 (-03)
</div>
</div>
