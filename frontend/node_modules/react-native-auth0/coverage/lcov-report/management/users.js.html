...
<html lang="en">
<head>
    <title>Code coverage report for management/users.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">management</a> users.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
function responseHandler (response, exceptions = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
...
&nbsp;
   ...
   * @memberof Users
   */
  getUser(parameters = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    const payload = apply({
      parameters: {
        id: { required: true }
      }
...
&nbsp;
   ...
   * @memberof Users
   */
  patchUser(parameters = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    const payload = apply({
      parameters: {
        id: { required: true },
