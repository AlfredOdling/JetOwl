...
<html lang="en">
<head>
    <title>Code coverage report for webauth/agent.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">webauth</a> agent.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    return new Promise((resolve, reject) =&gt; {
      ...
      NativeModules.A0Auth0.showUrl(url, closeOnLoad, (err) =&gt; {
        ...
        if (err) {
          reject(err);
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (closeOnLoad) {
          resolve();
        }
      });
    });
